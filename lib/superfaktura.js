...
const config = {
    headers: {
        'Authorization': `SFAPI email=${encodeURI(process.env.SF_AUTH_EMAIL)
...
exp.mapInvoiceToSFInvoice = function(i){
    ...
    sfi.Invoice = {
        ...
        created:  i.issuedOn && i.issuedOn.toISOString().substr(0,10),
        due: i.dueOn && i.dueOn.toISOString().substr(0,10),
        payment_type: 'transfer',
        paydate: i.paidOn && i.paidOn.toISOString().substr(0,10),
